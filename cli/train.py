...
batch_size = 32 #config['train']['batch_size']
epochs = 1 #config['train']['epochs']
hist_len = 1 #config['train']['hist_len']
pred_len = 24 #config['train']['pred_len']
weight_decay =0.0005 #config['train']['weight_decay']
early_stop = 10 #config['train']['early_stop']
lr = 0.0005 #config['train']['lr']
results_dir = '/results' #file_dir['results_dir']
dataset_num = 1 #config['experiments']['dataset_num']
exp_model = 'PM25_GNN' #config['experiments']['model']
exp_repeat = 1 #config['train']['exp_repeat']
save_npy = True #config['experiments']['save_npy']
